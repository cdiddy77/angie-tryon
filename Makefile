...
FRONTEND_FILTER := --filter=@weirdfingers/boards... --filter=@weirdfingers/boards-auth-clerk... --filter=@weirdfingers/boards-auth-jwt... --filter=@weirdfingers/boards-auth-supabase... --filter=angie-tryon...  --filter=@weirdfingers/baseboards...
DEV_FRONTEND_FILTER := --filter=@weirdfingers/boards... --filter=@weirdfingers/boards-auth-clerk... --filter=@weirdfingers/boards-auth-jwt... --filter=@weirdfingers/boards-auth-supabase... --filter=angie-tryon...
